...
def printHelp():
    ...
    print(" 5. Add a light-runttime-dump recording option based on                                                                                             ")
    print("               hdbcons 'runtimedump dump -c -s STACK_SHORT,THREADS' >> ${DUMP_NAME}                                                                 ")
    print("               hdbcons 'statreg print -h -n M_JOBEXECUTORS_' >> ${DUMP_NAME}                                                                        ")
    print("               hdbcons 'statreg print -h -n M_DEV_JOBEX_THREADGROUPS' >> ${DUMP_NAME}                                                               ")
    print("               hdbcons 'statreg print -h -n M_DEV_JOBEXWAITING' >> ${DUMP_NAME}                                                                     ")
    print("               hdbcons 'statreg print -h -n M_DEV_CONTEXTS' >> ${DUMP_NAME}                                                                         ")
    print("               hdbcons 'statreg print -h -n M_CONNECTIONS' >> ${DUMP_NAME}                                                                          ")
    print("               hdbcons 'statreg print -h -n M_DEV_SESSION_PARTITIONS' >> ${DUMP_NAME}                                                               ")
    print("                                                                                                                                                    ")
